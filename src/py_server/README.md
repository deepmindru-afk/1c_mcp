...
Настройки прокси: `MCP_HTTPPOLL_HOST` (127.0.0.1), `MCP_HTTPPOLL_TIMEOUT` — сколько ждать ответ агента (60 с). Проверка, что листенер жив: `curl http://127.0.0.1:9090/health`.
